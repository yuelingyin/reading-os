...
export default function ChapterReviewPage({ params }: Props) {
    ...
    <div className="min-h-screen bg-white text-black p-6 md:p-12">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight">章节复盘微打卡</h1>
          {book && (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="answersCoreQuestions" className="text-base">
                    灵魂拷问
                  </Label>
                  <p className="text-sm text-gray-500">
                    这一章是否解答了你立项时的核心问题？
                ...
                <div className="flex items-center gap-2">
                  {answersCoreQuestions && (
                    <CheckCircle className="w-5 h-5 text-green-600" />
                  )}
                  <Switch
                    id="answersCoreQuestions"
                    checked={answersCoreQuestions}
                    onCheckedChange={setAnswersCoreQuestions}
                  />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="reflection">简短感想</Label>
                <Textarea
                  id="reflection"
                  placeholder="记录你的读后感想、联想或疑问（选填）"
                  value={reflection}
              ...
              <div className="flex justify-end">
                <Button
                  type="submit"
                  disabled={isLoading || !chapterNumber || !userId}
