...
export default function ExtendPage({ params }: Props) {
      ...
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold tracking-tight">记录知识延伸点</h1>
          </div>
          {book && (
            <p className="text-gray-500 mt-2 ml-9">
              《{book.title}》
            </p>
          )}
        </div>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base font-normal text-gray-600">
              这本书为你打开了哪扇新大门？记录下感兴趣的关键词，或书中推荐的下一本书。
            </CardTitle>
          </CardHeader>
          <CardContent className="pt-0">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  id="keywords"
                  placeholder="多个词请用逗号分隔，例如：行为经济学, 丹尼尔·卡尼曼"
                  value={keywords}
              ...
              <div className="space-y-2">
                <Label htmlFor="recommendedTitle">推荐关联书名</Label>
                <Input
                  id="recommendedTitle"
                  placeholder="这本书让你想到的另一本书（选填）"
              ...
              <div className="space-y-2">
                <Label htmlFor="recommendedAuthor">推荐关联作者</Label>
                <Input
                  id="recommendedAuthor"
                  placeholder="该书作者（选填）"
                  value={recommendedAuthor}
                  onChange={(e) => setRecommendedAuthor(e.target.value)}
                />
              </div>
